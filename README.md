...
The application is cross-platform compatible with Windows, Linux and MacOS.
...
On Linux it's necessary to download the dipendencies for glfw (link here) and for NFDe (link here).
On MacOS (yet to test out)
